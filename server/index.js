...
// ❌ REMOVED: Global extractTenant middleware
// This was causing 401 errors because it requires req.user BEFORE protect runs
// Each route file now applies: protect → extractTenant → verifyTenantAccess
...
app.listen(PORT, () => {
  ...
  console.log(`✅ Tenant middleware applied at route level (not globally)`);
});
