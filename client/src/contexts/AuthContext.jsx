...
//     const companyId = localStorage.getItem('dev_company_id') || '2'; // ✅ Use company ID 2 (from migration)
...
//       // ✅ Store company_id for development mode
//       if (user.companyId) {
...
//     // ✅ Don't remove dev_company_id - keep it for next login in dev mode
//     // localStorage.removeItem('dev_company_id'); 
//   };
...
//         checkPermission, 
//         loading,
//         verifyToken // ✅ Expose verify method
//       }}
//     >
//       {children}
//     </AuthContext.Provider>
